...
export default function MapLegend({
  ...
  return (
    <div className="absolute bottom-6 left-6 z-[1000] bg-slate-900/90 backdrop-blur-md border border-slate-700/80 rounded-xl shadow-2xl p-3 text-xs select-none">
      <div className="flex items-center justify-between gap-3 mb-2 pb-1.5 border-b border-slate-800">
        <div className="flex items-center gap-1.5 font-bold text-slate-200">
          <Layers className="w-3.5 h-3.5 text-emerald-400" />
          <span>Claims Status Filter</span>
        </div>
